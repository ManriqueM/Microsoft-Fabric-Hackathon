...
- **Azure OpenAI**:
	- Creating a base dataset (3 dimension tables and 1 fact table) based on a file with data specifications [SpecsForGeneratingData/Data_Specs.txt](SpecsForGeneratingData/Data_Specs.txt)
